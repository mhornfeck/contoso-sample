...
{ 
    public class DepartmentController : Controller
    {
        ...
        {
            ViewBag.FullName = new SelectList(db.Instructors, "FullName", "FullName");
            return View();
        } 
        ...
        public ActionResult Create(Department department)
        {
            ...
            ViewBag.PersonID = new SelectList(db.Instructors, "PersonID", "PersonID", department.PersonID);
            return View(department);
        }
        ...
        public ActionResult Edit(Department department)
        {
            ...
            catch (DbUpdateConcurrencyException ex)
            {
                ...
                if (databaseValues.PersonID != clientValues.PersonID)
                    ModelState.AddModelError("FullName", "Current value: "
